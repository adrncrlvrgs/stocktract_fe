  ...
  return (
    <React.Fragment>
      ...
      <div className="font-[sans-serif] relative overflow-hidden min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
        ...
        />
        <motion.div
          className="absolute top-1/3 right-1/4 w-16 h-16 bg-purple-200 rounded-full opacity-50"
          variants={floatingShapeVariants}
          animate="float"
        />
        <motion.div
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center py-6 px-4 z-50">
          <motion.div
